...
From the confusion matrix in the output, we can see that the actual versus predicted classe variable is correct most of the time which illustrates the `r bestAccuracy`% accuracy rate of the random forest model. 
